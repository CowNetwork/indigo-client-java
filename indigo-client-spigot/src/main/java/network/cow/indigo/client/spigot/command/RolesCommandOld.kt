 ...
 * @author Tobias Büser
 */
class RolesCommandOld(private val plugin: IndigoPlugin) : CommandExecutor, TabCompleter {
    ...
    override fun onTabComplete(sender: CommandSender, cmd: Command, label: String, args: Array<out String>): MutableList<String> {
        ...
        if (args.size == 1) {
            val subCommands = mutableListOf("list", "info", "create", "delete", "permission", "get", "add", "remove")
